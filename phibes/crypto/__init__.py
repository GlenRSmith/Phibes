...
aes128_256 = register_crypt(
    Aes128CtrPbkdf2Sha256,
    key_rounds=100100
)
aes128_512 = register_crypt(
    Aes128CtrPbkdf2Sha512,
    key_rounds=100100,
    fallback_id=aes128_256,
)
aes192_256 = register_crypt(
    Aes192CtrPbkdf2Sha256,
    key_rounds=100100,
    fallback_id=aes128_512
)
aes192_512 = register_crypt(
    Aes192CtrPbkdf2Sha512,
    key_rounds=100100,
    fallback_id=aes192_256,
)
aes256_256 = register_crypt(
    Aes256CtrPbkdf2Sha256,
    key_rounds=100100,
    fallback_id=aes192_512
)
aes256_512 = register_default_crypt(
    Aes256CtrPbkdf2Sha512,
    key_rounds=100100,
    fallback_id=aes256_256,
)
